...
if (isset($_POST["hfAction"]) && $_POST["hfAction"] != "") {
    ...
    if ($_POST["hfAction"] == "add") {
        ...
        if ($id == "") {
            ...
            $sql = "update tbl_category set cat_name='" . mysqli_real_escape_string($cn, $_REQUEST['txtcatname']) . "',cat_desc='" . mysqli_real_escape_string($cn, $_REQUEST["txtcatdesc"]) . "',cat_img='" . $filename . "' where cat_id='" . $id . "'";
        }
